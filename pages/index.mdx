...
<div className="home-content">
  <div className="content-container">
    <div className="features-container">
      ...
      여러분의 취업을 위한 4주 완성 올인원 패키지, [커리어 패스트트랙](https://vanilla-coding.notion.site/12d37205ef948011a61df75c3a978d42)에 등록해주셔서 감사드립니다.

      ## 코스 시작 전 할일

      1. 메일로 전달된 사전 제출 양식에 대해 회신해주세요. 개인 프로젝트 정보를 기입하여 전달해주셔야 합니다.
      2. 코스 시작 1일 전, 수업 ZOOM 링크가 메일로 전달됩니다. 잊지 마시고, 확인해주세요.

      코스 시작일에 ZOOM에서 뵙도록 하겠습니다. 추가적으로 궁금한 점은 [채팅 문의](https://vanillacoding.channel.io/)로 연락주세요.
