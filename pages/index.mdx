...
<div className="home-content">
  <div className="content-container">
    <div className="features-container">
      ...
      전공 지식 함양을 위한 4주 완성 코스 , CS 코어 캠프에 등록해주셔서 감사드립니다.

      현재 보시는 페이지는 코스 진행 과정에서 코스 콘텐츠가 공유될 페이지입니다.

      코스 관련 안내사항은 코스 시작 1주일 전, 메일로 전달드릴 예정입니다. 관련하여 궁금한 점은 [채팅 문의](https://vanillacoding.channel.io/)로 연락주세요.
